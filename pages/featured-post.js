      ...
      <section className="text-gray-600 body-font ">
             ...
             <span className="date ml-16 text-gray-500 text-sm">July 4, 2022</span>
              ...
              <div className="container  py-10 mx-auto">
               ...
               <h1 className='font-mono text-black text-4xl title-font font-bold mb-2 hover:text-purple-300 '>  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="inline-block w-8 h-8 text-gray-400 mb-8" viewBox="0 0 975.036 975.036">
