...
export default function Index() {
  ...
  <div className="h-screen w-full bg-white relative flex overflow-hidden">
   ...
   <div className="w-full h-full flex flex-col justify-between">
    ...
    <main className="display dark:bg-body font-mono max-w-full h-full flex relative overflow-y-hidden">
      ...
      <div className="content h-full w-full  flex flex-wrap items-start justify-start rounded-tl grid-flow-col auto-cols-max gap-4 overflow-y-scroll overflow-x-hidden">
       ...
       <div className="post bg-essay dark:bg-content font-mono w-full h-95 rounded-lg flex-shrink-0 flex-grow essayColor">
                <section className="h-85 text-gray-600 dark:text-lessGray body-font container ">
                        ...
                        <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                            ...
                            <div className="dark:text-whiter md:flex font-bold text-gray-800">
                                <div className="w-full md:w-1/2 flex space-x-3">
                                    <div className="w-1/2">
                                        <h2 className="text-gray-500  dark:text-lessGray">Tag</h2>
                                        <p>technology</p>
                                    </div>
                                    <div className="w-1/2">
                                        <h2 className="text-gray-500 dark:text-lessGray">Tag</h2>
      ...
      <div className="mobileTitle bg-essay dark:bg-content font-mono w-full h-95 rounded-lg flex-shrink-0 flex-grow essayColor">
                <section className="h-85 text-gray-600 body-font container dark:text-lessGray">
                    <div className=" px-5 py-5 mx-auto">
                        <div className="dark:bg-dev p-5 bg-white flex items-center mx-auto border-b  border-gray-200 rounded-lg sm:flex-row flex-col">
                        <div className="sm:w-46 sm:h-46 h-72 w-72 sm:mr-10 inline-flex items-center justify-center flex-shrink-0">
                        <Image height={300} width={500} src="/cat.webp" alt="cat" />
                        ...
                        <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0 ">
                            ...
                            <Link href="https://fairydevmother.substack.com/p/pandemic-developer?utm_source=profile&utm_medium=reader2" className="font-mono  dark:text-whiter text-black text-4xl title-font font-bold mb-2 hover:text-purple-300 mt-3 inline-flex items-center">
                               Pandemic Developer
                             </Link>
    ...
    <div  key={post.id} className="post w-96 bg-essay dark:bg-content  rounded-lg flex-shrink-0 flex-grow essayColor">
       
    <section className="container text-gray-600 dark:text-lessGray body-font">
                  <div key={post.id} className=" px-5 py-5 mx-auto">
                      ...
                      <Link className="mt-3 text-blue-500 inline-flex items-center hover:text-blue-800" href={post.slug}>
                        Read More In Substack
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                              <path d="M5 12h14M12 5l7 7-7 7"></path>
                        </svg>
    ...
    <div key={post.id} className="mobileTitle bg-essay w-96 dark:bg-content rounded-lg flex-shrink-0 flex-grow essayColor">
    ...
    <section className="container text-gray-600 dark:text-lessGray body-font">
                  <div key={post.id} className=" px-5 py-5 mx-auto">
                      ...
                      <Link className="font-mono text-black  dark:text-whiter text-2xl title-font font-bold mb-2 hover:text-blue-300" href={post.slug}>
                       {post.title}
