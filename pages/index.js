...
export default function Index() {
  ...
  <div className="h-screen w-full bg-white relative flex overflow-hidden">
   ...
   <div className="w-full h-full flex flex-col justify-between">
    ...
    <div key={post.id} className="mobileTitle w-96   rounded-lg flex-shrink-0 flex-grow essayColor">
    ...
    <section className="container text-gray-600 body-font">
                  <div key={post.id} className=" px-5 py-5 mx-auto">
                      ...
                      <Link className="font-mono text-black text-2xl title-font font-bold mb-2 hover:text-blue-300" href={`/article/${post.slug}`}>
                       {post.title}
